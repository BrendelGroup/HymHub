...
HymHub provides descriptive statistics of several genome features for 13 species in the order Hymenoptera.
These summary statistics are stored in tabular format (tab-separated values or TSV) to facilitate loading into popular statistics packages for analysis.This notebook provides a brief demo for loading the data into R for analysis.
This demo will focus on interval loci (iLoci), but everything in this demo also  applies to the data tables for other genomic features available from HymHub.
